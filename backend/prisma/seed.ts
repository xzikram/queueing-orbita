...
async function main() {
  ...
  // ========================
  // 5.1 BDR USERS (NIK = Username & Password)
  // ========================
  const bdrUsers = [
  ...
  const accessGroups = [
    ...
    { role: 'ASSESSMENT' as const, name: 'Pengkajian', permissions: ['dashboard', 'assessment', 'doctor', 'cdc'] },
    { role: 'BDR' as const, name: 'BDR', permissions: ['dashboard', 'bdr'] },
    { role: 'DOCTOR' as const, name: 'Dokter', permissions: ['dashboard', 'assessment', 'doctor', 'cdc'] },
    { role: 'CDC' as const, name: 'CDC', permissions: ['dashboard', 'assessment', 'doctor', 'cdc'] },
